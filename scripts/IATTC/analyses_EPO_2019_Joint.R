...
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = TRUE, dohbf = FALSE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 20)
...
resdir <- paste0(jntalysis_dir,"cl0_hb1_hk1_kr/")
dir.create(resdir);setwd(resdir)
...
resdir <- paste0(jntalysis_dir,"cl1_hb1_hk1_kr/")
dir.create(resdir); setwd(resdir)
...
# with clusters, hooks, no hbf
resdir <- paste0(jntalysis_dir,"cl1_hb0_hk1_fn/")
dir.create(resdir);setwd(resdir)
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = TRUE, dohbf = FALSE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 20)
run_standardization(runpars, doflags = c("JP","KR"), regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0 , jplimit = list(reg=0, yr=21000), krlimit = list(reg=1, yr=c(1990, 21000)))

# no clusters, with hooks, hbf
resdir <- paste0(jntalysis_dir,"cl0_hb1_hk1_fn/")
dir.create(resdir);setwd(resdir)
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = FALSE, dohbf = TRUE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 20)
run_standardization(runpars, doflags = c("JP","KR"), regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0, jplimit = list(reg=0, yr=21000), krlimit = list(reg=1, yr=c(1990, 21000)))

# with clusters, hooks, hbf
resdir <- paste0(jntalysis_dir,"cl1_hb1_hk1_fn/")
dir.create(resdir); setwd(resdir)
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = TRUE, dohbf = TRUE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 20)
run_standardization(runpars, doflags = c("JP","KR"), regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0, jplimit = list(reg=0, yr=21000), krlimit = list(reg=1, yr=c(1990, 21000)))

# no clusters, with hooks, no hbf
resdir <- paste0(jntalysis_dir,"cl0_hb0_hk1_fn/")
dir.create(resdir); setwd(resdir)
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 2:4, ylall = c(1979, 2018), addcl = FALSE, dohbf = FALSE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 20)
run_standardization(runpars, doflags = c("JP","KR"), regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0, jplimit = list(reg=0, yr=21000), krlimit = list(reg=1, yr=c(1990, 21000)))
