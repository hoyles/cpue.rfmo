...
#  rng <- data.frame(st = c(1950, 1970, 1986), nd = c(1969, 1985, 2050), mlt = c(-1, 1, -1))
  ...
  sz$lat <- sz$latitude
  sz$lon <- sz$longitude
  sz$lat[sz$latitude_code==2] <- sz$latitude [sz$latitude_code==2] * -1
  sz$lon[sz$longitude_code==2] <- 360 - sz$longitude[sz$longitude_code==2]
  #  sz <- sz[sz$longitude_code==1,]
  sz$lat[sz$level==1 & sz$latitude_code==1] <- sz$lat[sz$level==1 & sz$latitude_code==1] + 5
  sz$lon[sz$level==1 & sz$latitude_code==1] <- sz$lon[sz$level==1 & sz$latitude_code==1] + 10
  sz$lat[sz$level==2 & sz$latitude_code==1] <- sz$lat[sz$level==2 & sz$latitude_code==1] + 2.5
  sz$lon[sz$level==2 & sz$latitude_code==1] <- sz$lon[sz$level==2 & sz$latitude_code==1] + 5
  sz$lat[sz$level==3 & sz$latitude_code==1] <- sz$lat[sz$level==3 & sz$latitude_code==1] + 2.5
  sz$lon[sz$level==3 & sz$latitude_code==1] <- sz$lon[sz$level==3 & sz$latitude_code==1] + 2.5
  sz$lat[sz$level==4 & sz$latitude_code==1] <- sz$lat[sz$level==4 & sz$latitude_code==1] + .5
  sz$lon[sz$level==4 & sz$latitude_code==1] <- sz$lon[sz$level==4 & sz$latitude_code==1] + .5
  sz$lat[sz$level==1 & sz$latitude_code==2] <- sz$lat[sz$level==1 & sz$latitude_code==2] - 5
  sz$lon[sz$level==1 & sz$latitude_code==2] <- sz$lon[sz$level==1 & sz$latitude_code==2] + 10
  sz$lat[sz$level==2 & sz$latitude_code==2] <- sz$lat[sz$level==2 & sz$latitude_code==2] - 2.5
  sz$lon[sz$level==2 & sz$latitude_code==2] <- sz$lon[sz$level==2 & sz$latitude_code==2] + 5
  sz$lat[sz$level==3 & sz$latitude_code==2] <- sz$lat[sz$level==3 & sz$latitude_code==2] - 2.5
  sz$lon[sz$level==3 & sz$latitude_code==2] <- sz$lon[sz$level==3 & sz$latitude_code==2] + 2.5
  sz$lat[sz$level==4 & sz$latitude_code==2] <- sz$lat[sz$level==4 & sz$latitude_code==2] - .5
  sz$lon[sz$level==4 & sz$latitude_code==2] <- sz$lon[sz$level==4 & sz$latitude_code==2] + .5

  sz$lat1 <- sz$lat
  sz$lon1 <- sz$lon
  sz$lat1[sz$level %in% c(1,2,3)] <- NA
  sz$lon1[sz$level %in% c(1,2,3)] <- NA

  sz$lat5 <- 5 * floor(sz$lat/5) +2.5
  sz$lon5 <- 5 * floor(sz$lon/5) +2.5
  sz$lat5[sz$level %in% c(1,2)] <- NA
  sz$lon5[sz$level %in% c(1,2)] <- NA

  sz$lat510 <- 5 * floor(sz$lat/5) +2.5
  sz$lon510 <- 10 * floor(sz$lon/10) +5
  sz$lat510[sz$level %in% c(1)] <- NA
  sz$lon510[sz$level %in% c(1)] <- NA
