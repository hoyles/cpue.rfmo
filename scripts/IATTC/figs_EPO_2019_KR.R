...
make_reg_windows <- function(type=1) {
  if(type == 1) windows(height=14,width=12); par(mfcol=c(2,2),mar=c(3,4,2,1))
...
a5 <- aggregate(cbind(alb,bet,blm,bum,mls,oth,sfa,sha,skj,swo,yft,Total,Total2,hooks) ~ lon5 + lat5 + eval(5*floor((op_yr)/5)),data=dat,FUN=sum)
a <- aggregate(cbind(alb,bet,blm,bum,mls,oth,sfa,sha,skj,swo,yft,Total,Total2,hooks) ~ lon + lat + eval(5*floor((op_yr)/5)),data=dat,FUN=sum)
...
for(d in seq(1975,2015,5)) plot_catchmap(indat=a5,vbl=a5$bet/(a5$bet+a5$yft),dcd=d,latlim=c(-18,10),lonlim=c(140,290),ti="BET / BET + YFT", maptype="EPO")
savePlot("PropBET in YFT_BET5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$bet/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET / Total", maptype="EPO")
savePlot("PropBET in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$swo/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSWO in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$alb/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB / Total",brk2=seq(0,1,.1), maptype="EPO")
savePlot("PropALB in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$sfa/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSFA in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$sha/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSHA in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$yft/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT / Total", maptype="EPO")
savePlot("PropYFT in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$mls/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropMLS in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$blm/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropBLM in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$bum/(a5$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropBUM in Total5",type="png")

windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$bet/(a$bet+a$yft),dcd=d,latlim=c(-15,25),lonlim=c(140,290),ti="BET / BET + YFT", maptype="EPO")
savePlot("PropBET in YFT_BET",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$bet/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET / Total", maptype="EPO")
savePlot("PropBET in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$swo/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSWO in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$alb/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB / Total",brk2=seq(0,1,.1), maptype="EPO")
savePlot("PropALB in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$sfa/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSFA in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$sha/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropSHA in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$yft/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT / Total", maptype="EPO")
savePlot("PropYFT in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$mls/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropMLS in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$blm/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropBLM in Total",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a,vbl=a$bum/(a$Total),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM / Total",brk2=seq(0,1,.05), maptype="EPO")
savePlot("PropBUM in Total",type="png")

########### relative to YBA
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015,5)) plot_catchmap(indat=a,vbl=a$bet/(a$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET / YBA Total", maptype="EPO")
savePlot("PropBET in altTotal",type="png")
for(d in seq(1975,2015,5)) plot_catchmap(indat=a,vbl=a$alb/(a$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB / YBA Total",brk2=seq(0,1,.1), maptype="EPO")
savePlot("PropALB in altTotal",type="png")
for(d in seq(1975,2015,5)) plot_catchmap(indat=a,vbl=a$yft/(a$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT / YBA Total", maptype="EPO")
savePlot("PropYFT in altTotal",type="png")

windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$bet/(a5$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET / YBA Total", maptype="EPO")
savePlot("PropBET in altTotal5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$alb/(a5$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB / YBA Total",brk2=seq(0,1,.1), maptype="EPO")
savePlot("PropALB in altTotal5",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap(indat=a5,vbl=a5$yft/(a5$Total2),dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT / YBA Total", maptype="EPO")
...
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$bet,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET Catch", maptype="EPO")
savePlot("Catchmap_BET",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$swo,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO Catch", maptype="EPO")
savePlot("Catchmap_SWO",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$alb,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB Catch", maptype="EPO")
savePlot("Catchmap_ALB",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$sfa,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA Catch", maptype="EPO")
savePlot("Catchmap_sfa",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$sha,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA Catch", maptype="EPO")
savePlot("Catchmap_SHA",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$yft,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT Catch", maptype="EPO")
savePlot("Catchmap_YFT",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$mls,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS Catch", maptype="EPO")
savePlot("Catchmap_MLS",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$blm,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM Catch", maptype="EPO")
savePlot("Catchmap_BLM",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$bum,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM Catch", maptype="EPO")
savePlot("Catchmap_BUM",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$oth,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="OTH Catch", maptype="EPO")
savePlot("Catchmap_OTH",type="png")
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a,vbl=a$skj,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SKJ Catch", maptype="EPO")
savePlot("Catchmap_SKJ",type="png")

windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$bet,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_BET",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$swo,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_SWO",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$alb,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_ALB",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$sfa,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_sfa",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$sha,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_SHA",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$yft,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_YFT",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$mls,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_MLS",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$blm,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_BLM",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$bum,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_BUM",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$oth,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="OTH Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_OTH",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_catchmap2(indat=a5,vbl=a5$skj,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SKJ Catch", delta=5, maptype="EPO")
savePlot("Catchmap5_SKJ",type="png")

#CPUE maps
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$bet,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET CPUE", maptype="EPO")
savePlot("Cpuemap_BET",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$swo,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO CPUE", maptype="EPO")
savePlot("Cpuemap_SWO",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$alb,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB CPUE", maptype="EPO")
savePlot("Cpuemap_ALB",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$sfa,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA CPUE", maptype="EPO")
savePlot("Cpuemap_sfa",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$sha,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA CPUE", maptype="EPO")
savePlot("Cpuemap_SHA",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$yft,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT CPUE", maptype="EPO")
savePlot("Cpuemap_YFT",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$mls,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS CPUE", maptype="EPO")
savePlot("Cpuemap_MLS",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$blm,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM CPUE", maptype="EPO")
savePlot("Cpuemap_BLM",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$bum,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM CPUE", maptype="EPO")
savePlot("Cpuemap_BUM",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$oth,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="OTH CPUE", maptype="EPO")
savePlot("Cpuemap_OTH",type="png")
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a,vb1=a$skj,vb2=a$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SKJ CPUE", maptype="EPO")
savePlot("Cpuemap_SKJ",type="png")

windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$bet,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BET CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_BET",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$swo,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SWO CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_SWO",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$alb,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="ALB CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_ALB",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$sfa,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SFA CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_sfa",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$sha,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SHA CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_SHA",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$yft,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="YFT CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_YFT",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$mls,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="MLS CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_MLS",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$blm,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BLM CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_BLM",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$bum,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="BUM CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_BUM",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$oth,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="OTH CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_OTH",type="png")
windows(width=20,height=15);par(mfrow=c(3,3), mar = c(4,4,2,1)+.1)
for(d in seq(1975,2015, 5)) plot_cpuemap2(indat=a5,vb1=a5$skj,vb2=a5$hooks,dcd=d,latlim=c(-45,40),lonlim=c(140,290),ti="SKJ CPUE", delta=5, maptype="EPO")
savePlot("CPUEmap5_SKJ",type="png")

#####################################
#Prepare figures
# Logsheets per year by region
windows(height=14,width=18); par(mfrow=c(2,2),mar=c(2,1,2,1),oma=c(0,0,1,0))
...
windows(height=14,width=16); par(mfrow=c(2,2),mar=c(2,2,2,1))
for (r in regBEord) {
  llv <- dat[dat$regBepo==r,]
...
windows(height=14,width=16); par(mfrow=c(2,2),mar=c(4,3,2,1))
for (r in regBEord) {
  llv <- dat[dat$regBepo==r,]
...
#    }
  ...
  vy[[r]] <- vessyrs
  plot(1:length(vess),1:length(vess),xlim=c(1975,2020),type="n",xlab="Years",ylab="Vessel",main=paste("Region",r))
  for (i in 1:length(vess)) {
...
#windows(height=14,width=16); par(mfrow=c(2,2),mar=c(3,4,2,1))
#for (r in regBEord) {
#  llv <- dat[dat$regBepo==r,]
#  a <- tapply(llv$hooks,llv$yrqtr,length)
#  plot(names(a),a,xlab="Year",ylab="Sets",main=paste("Region",r),col=1,pch=16)
#  llv <- dat[dat$regBepo==r & dat$newfishingcat==1,]
#  a <- tapply(llv$hooks,llv$yrqtr,length)
#  points(names(a),a,col=2,pch=2)
#  llv <- dat[dat$regBepo==r & dat$newfishingcat==2,]
#  a <- tapply(llv$hooks,llv$yrqtr,length)
...
e <- tapply(dat$hooks,list(dat$yrqtr,dat$regBepo),sum)
...
for(dec in seq(1975,2010,5)) {
  ...
  image(as.numeric(dimnames(bs)[[1]]),as.numeric(dimnames(bs)[[2]]),bs,col="lightblue",xlab="Longitude",ylab="Latitude",xlim=c(140,290),ylim=c(-15,25),main=dec, xaxt="n")
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,xlab="Longitude",ylab="Latitude", xlim=c(140,290),main=dec,add=T,breaks=exp(seq(log(min(x,na.rm=T)),log(max(x*1.01,na.rm=T)),length.out=13)))
  contour(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,add=T,
    levels=c(10,10^2,10^3,10^4,10^5,10^6,10^7,10^8,10^9,10^10,10^1,10^12,10^13))
  map_EPO()
  }
savePlot(filename=paste0("Map hooks by decade log"),type="png")


windows(height=15,width=20); par(mfrow=c(3,3),mar=c(3,4,2,1))
ax <- expand.grid(latfac=unique(dat$latfac),lonfac=unique(dat$lonfac),hooks=NA)
bs <- tapply(ax$hooks,list(ax$lonfac,ax$latfac),length)
for(dec in seq(1975,2015,5)) {
  ...
  image(as.numeric(dimnames(bs)[[1]]),as.numeric(dimnames(bs)[[2]]),bs,col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(140,290),ylim=c(-15,25),main=dec, xaxt="n")
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,xlab="Longitude",ylab="Latitude",
    xlim=c(140,290),main=dec,add=T,breaks=exp(seq(0,8,length.out=13)))
  contour(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,add=T,
    levels=c(10,10^2,10^3,10^4,10^5,10^6,10^7,10^8,10^9,10^10,10^11))
  map_EPO()
  }
...
for(dec in seq(1975,2015,5)) {
  ...
  image(as.numeric(dimnames(bs)[[1]]),as.numeric(dimnames(bs)[[2]]),bs,col="lightblue",xlab="Longitude",ylab="Latitude",xlim=c(140,290),ylim=c(-45,40),main=dec, xaxt="n")
...
for(dec in seq(1975,2015,5)) {
  ...
  x <- tapply(a$hooks,list(a$lonfac,a$latfac),length)
  image(as.numeric(dimnames(bs)[[1]]),as.numeric(dimnames(bs)[[2]]),bs,col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(140,290),ylim=c(-45,40),main=dec, xaxt="n")
...
windows(height=16,width=20); par(mfrow=c(5,5),mar=c(1,1,2,1))
llv <- dat
ax <- expand.grid(latfac=unique(dat$latfac),lonfac=unique(dat$lonfac),hooks=NA)
bs <- tapply(ax$hooks,list(ax$lonfac,ax$latfac),length)
for(dec in seq(1993,2017,1)) {
  a <- llv[llv$op_yr >= dec & llv$op_yr < dec+1,]
  x <- tapply(a$hooks,list(a$lonfac,a$latfac),length)
  image(as.numeric(dimnames(bs)[[1]]),as.numeric(dimnames(bs)[[2]]),bs,col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(140,290),ylim=c(-45,40), xaxt="n")
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,xlab="Longitude",ylab="Latitude",
    xlim=c(140,290),add=T,breaks=exp(seq(0,11,length.out=13)))
...
dat$ssp <- apply(dat[,c("alb","bet","blm","bum","mls","oth","sfa","sha","skj","swo","yft")],1,lenzero)
table(dat$ssp)
...
prepdat <- setup_AO_regions(prepdat, regBepo = TRUE, regB1 = TRUE)
windows(height=14,width=16); par(mfrow=c(2,2),mar=c(3,4,2,1))
for (r in regBEord) {
...
for (r in regBEord) {
  ...
  if(r==1) legend("bottomright",legend=c("Yellowfin","Bigeye","Albacore","Swordfish"),col=c(1,2,3,4),pch=c(1,2,3,4))
  }
...
for (r in regBEord) {
  ...
  if(r==2) legend("topright",legend=c("Swordfish","Striped marlin","Black marlin","Blue marlin","Sailfish"),col=1:5,pch=1:5)
  }
...
for (r in regBEord) {
  ...
  if(r==2) legend("topright",legend=c("Other","Shark","Skipjack"),col=1:3,pch=1:3)
  }
...
#  points(names(swo),swo+1,col=4,pch=4)
  ...
  if(r==2) legend("topright",legend=c("Yellowfin","Bigeye","Albacore", "Swordfish"),col=c(1,2,3,4),pch=c(1,2,3,4))
  }
...
for (r in regBEord) {
  ...
  points(names(alb),alb,col=3,pch=3)
  points(names(swo),swo,col=4,pch=4)
  if(r==4) legend("bottomright",legend=c("Yellowfin","Bigeye","Albacore","Swordfish"),col=c(1,2,3,4),pch=c(1,2,3,4))
  }
...
for (r in regBEord) {
  ...
  points(names(sfa),sfa,col=5,pch=5)
  if(r==4) legend("bottomright",legend=c("Swordfish","Striped marlin","Black marlin","Blue marlin","Sailfish"),col=1:5,pch=1:5)
  }
...
for (r in regBEord) {
  ...
  points(names(sha),sha,col=2,pch=2)
  points(names(skj),skj,col=3,pch=3)
  if(r==2) legend("bottomright",legend=c("Other","Shark","Skipjack"),col=1:3,pch=1:3)
  }
...
for (r in regBEord) {
  ...
  points(names(bum),bum,col=4,pch=4)
  points(names(sfa),sfa,col=5,pch=5)
  if(r==2) legend("topright",legend=c("Swordfish","Striped marlin","Black marlin","Blue marlin","Sailfish"),col=c(1,2,3,4,5),pch=c(1,2,3,4,5))
}
...
#for (fc in 1:2) {
#  for (r in regBEord) {
#    llv <- dat[dat$regBepo==r & dat$newfishingcat==fc,]
#    yft <- tapply(llv$yft,llv$yrqtr,sum)
#    eff <- tapply(llv$hooks,llv$yrqtr,sum)
#    bet <- tapply(llv$bet,llv$yrqtr,sum)
#    alb <- tapply(llv$alb,llv$yrqtr,sum)
...
for (r in regBEord) {
  ...
  if(r==2) legend("topright",legend=c("Yellowfin","Bigeye"),col=c(1,2),pch=c(1,2))
  }
...
for (r in regBEord) {
  ...
  if(r==3) legend("bottomleft",legend=c("Swordfish","Striped marlin","Blue marlin","Black marlin","Sailfish"),col=1:5,pch=1:5)
    }
...
for (r in regBEord) {
  ...
  if(r==3) legend("bottomleft",legend=c("Other species","Sharks","Skipjack","Sailfish"),col=1:4,pch=1:4)
    }
...
for(yr in seq(1975,2015,by=5)) {
  ...
  for (i in 1:length(lats)) {
    text(lons+2.5,rep(lats[i],length(lons))+2.5,floor(a[i,]),col=1,add = T, cex=0.8)
    }
  }
...
for(yr in seq(1975,2015,by=5)) {
  ...
  for (i in 1:length(lats)) {
    text(lons+2.5,rep(lats[i],length(lons))+2.5,(a[i,]),col=1, cex=0.8)
    }
  }
savePlot("Plot map median HBF", type="png")

# Plot hbf by region by year
  windows(height=14,width=16); par(mfcol=c(2,2),mar=c(3,4,2,1),oma=c(1,1,3,1)); r<-3; hh <- 18
  b<- dat
  for (r in regBEord) {
    a <- b[b$regBepo==r,]
    ...
    for(i in 1:length(ilist)){
      ...
      if(trunc(i/5) == i/5){
      lines(c(1950,2017), rep(i,2), lty=3)}
      }
    }
...
windows(height=14,width=16); par(mfcol=c(2,2),mar=c(4,4,2,2), oma=c(0,0,2,0))
for (r in regBEord) {
  a <- dat[dat$regBepo==r,]
  yrs <- sort(unique(a$op_yr))
...
mtext("Bigeye", outer=TRUE, side=3)
...
mtext("Yellowfin", outer=TRUE, side=3)
...
mtext("Albacore", outer=TRUE, side=3)
...
mtext("Swordfish", outer=TRUE, side=3)
...
plot_pzero_ll <- function(a,sp,la,lo) {
 # if(la == -30) browser()
  ...
  plot(1,1, type="n", xlab="Year", ylab="HBF", ylim = c(1,23), xlim=range(dat$yrqtr),main=paste(la,lo,sep=", "))
  ilist <- as.numeric(row.names(a))
  if(length(ilist) > 0) {
    for(i in 1:length(ilist)){
...
for(sp in c("alb","bet","blm","bum","mls","oth","sfa","sha","skj","swo","yft"))
{
  names(dat)
  windows(height=14,width=24); par(mfrow=c(4,6),mar=c(2,2,2,0),oma=c(0,0,3,0))
  for (la in seq(7.5,-7.5,by=-5)) {
    for (lo in seq(212.5,237.5,by=5)) {
      a <- data.frame(dat[dat$lat5==la & dat$lon5 %in% c(lo),])
...
for(sp in c("alb","bet","blm","bum","mls","oth","sfa","sha","skj","swo","yft"))
{
  ...
  for (la in seq(7.5,-7.5,by=-5)) {
    for (lo in seq(242.5,277.5,by=5)) {
      a <- data.frame(dat[dat$lat5==la & dat$lon5 %in% c(lo),])
      if(dim(a)[[1]] >0)  plot_pzero_ll(a,sp,la,lo) else plot(1,1,type="n")
    }
  }
...
{
  names(dat)
  windows(height=14,width=24); par(mfrow=c(6,6),mar=c(2,2,2,0),oma=c(0,0,3,0))
...
{
  names(dat)
  windows(height=14,width=24); par(mfrow=c(5,8),mar=c(2,2,2,0),oma=c(0,0,3,0))
  for (la in seq(-12.5,-32.5,by=-5)) {
    for (lo in seq(242.5,277.5,by=5)) {
      a <- data.frame(dat[dat$lat5==la & dat$lon5 %in% c(lo),])
      if(dim(a)[[1]] >0)  plot_pzero_ll(a,sp,la,lo) else plot(1,1,type="n")
    }
  ...
  title(sp,outer=T,line=1)
  savePlot(paste("plot pzero",sp,"by hbf by R4 latlong2"),type="png")
}
...
pzero_hbf_sp_yq <- function(sp,laseq,loseq,fname,ti="") {
  ...
  b <- as.data.frame(dat[dat$lat5 %in% laseq & dat$lon5 %in% loseq,])
  for (la in laseq) {
    for (lo in loseq) {
...
pzero_hbf_sp_yq("bet",laseq=seq(5,-10,-5)+2.5,loseq=seq(210,235,5)+2.5,fname="plot pzero bet by hbf by R1 latlong",ti="Bigeye Region 1")
pzero_hbf_sp_yq("yft",laseq=seq(5,-10,-5)+2.5,loseq=seq(210,235,5)+2.5,fname="plot pzero yft by hbf by R1 latlong",ti="Yellowfin Region 1")
pzero_hbf_sp_yq("alb",laseq=seq(5,-10,-5)+2.5,loseq=seq(210,235,5)+2.5,fname="plot pzero alb by hbf by R1 latlong",ti="Albacore Region 1")
...
#dat <- dataprep(dat)
#dat <- dat[dat$regBepo > 0 & dat$regBepo <=6,c("tonnage","fishingcat","ncrew","target","mainline","branchline","op_yr","dat_mon","dat_day","lat","lon","hbf",
#          "hooks","bet","yft","alb","lat5","lon5","regBepo","subreg","vessid","yrqtr","latlong","cstart_yr","cstart_mon","cstart_day")]
...
write.csv(table(dat$hbf,floor(dat$yrqtr/5)*5,dat$regBepo),file="hbf by region by 5 years.csv")
windows();par(mfcol=c(2,1))
for(i in regBEord) {
  a <- dat[dat$regBepo==i,]
  hist(a$alb,nclass=50,xlab="Albacore catch",xlim=c(0,250),main=paste("Region",i))
}
savePlot("hist alb by regBepo",type="png")
...
plot_catch <- function(a,la,lo,ymax) {
  ...
  lines(yrs,swo,col=4,lty=4,cex=cx)
  }
catch_all_sp_yq <- function(laseq,loseq,fname,ti="",ymax) {
  ...
  legend("topright",legend=c("Yellowfin","Bigeye","Albacore","swo"),lty=c(1:4),col=c(1:4))
  title(ti,outer=T)
  savePlot(fname,type="png")
  }
