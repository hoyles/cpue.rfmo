...
a <- with(dat[!is.na(dat$lat) & dat$yrqtr >= 2010 & dat$yrqtr < 2015,],log(table(lon,lat)))
windows(width=15,height=10)
image(as.numeric(dimnames(a)[[1]])+.5,as.numeric(dimnames(a)[[2]])+.5,a,xlab="Longitude",ylab="Latitude")
map("worldHires",add=T, interior=F,fill=T)
savePlot("Setmap_logscale_2010-2014.png",type="png")

a <- with(dat[!is.na(dat$lat) & dat$yrqtr & dat$yrqtr >= 1990,],log(table(lon,lat)))
windows(width=15,height=10)
image(as.numeric(dimnames(a)[[1]])+.5,as.numeric(dimnames(a)[[2]])+.5,a,xlab="Longitude",ylab="Latitude")
map("worldHires",add=T, interior=F,fill=T)
savePlot("Setmap_logscale_1990-2014.png",type="png")
...
dat[dat$lon==61 & dat$lat== -2 & !is.na(dat$lon) & dat$regY==3,]
dat[dat$callsign=="61BEE" & dat$op_yr==2001 & dat$op_mon==1,]
...
a <-  aggregate(cbind(bet,yft,alb,sbt,ott,swo,mls,blm,bum,otb,sha,skj,oth,Total,Total2,hooks) ~ lon + lat + eval(5*floor((op_yr+5)/5)-5),data=dat[!is.na(dat$lon),],FUN=sum)
a5 <- aggregate(cbind(bet,yft,alb,sbt,ott,swo,mls,blm,bum,otb,sha,skj,oth,Total,Total2,hooks) ~ lon5 + lat5 + eval(10*floor((op_yr)/10)),data=dat,FUN=sum)
names(a)[3] <- names(a5)[3] <- "decade"
names(a5)[1:2] <- c("lon","lat")

windows(width=20,height=15);par(mfrow=c(2,2))
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$bet/(a$bet+a$yft),dcd=d,latlim=c(-18,10),lonlim=c(40,120),ti="BET / BET + YFT")
savePlot("PropBET in YFT_BET5",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$bet/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET / Total")
savePlot("PropBET in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$swo/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO / Total",brk2=seq(0,1,.05))
savePlot("PropSWO in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$alb/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB / Total",brk2=seq(0,1,.1))
savePlot("PropALB in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$otb/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA / Total",brk2=seq(0,1,.05))
savePlot("PropOTB in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$sha/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA / Total",brk2=seq(0,1,.05))
savePlot("PropSHA in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$yft/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT / Total")
savePlot("PropYFT in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$mls/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS / Total",brk2=seq(0,1,.05))
savePlot("PropMLS in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$sbt/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT / Total",brk2=seq(0,1,.05))
savePlot("PropSBT in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$blm/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM / Total",brk2=seq(0,1,.05))
savePlot("PropBLM in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$bum/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM / Total",brk2=seq(0,1,.05))
savePlot("PropBUM in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$oth/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH / Total",brk2=seq(0,1,.05))
savePlot("PropOTH in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$skj/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ / Total",brk2=seq(0,1,.05))
savePlot("PropSKJ in Total",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$ott/(a$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT / Total",brk2=seq(0,1,.05))
savePlot("PropOTT in Total",type="png")

windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$bet/(a5$bet+a5$yft),dcd=d,latlim=c(-18,10),lonlim=c(40,120),ti="BET / BET + YFT")
savePlot("PropBET in YFT_BET5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$bet/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET / Total")
savePlot("PropBET in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$swo/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO / Total",brk2=seq(0,1,.05))
savePlot("PropSWO in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$alb/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB / Total",brk2=seq(0,1,.1))
savePlot("PropALB in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$otb/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA / Total",brk2=seq(0,1,.05))
savePlot("PropOTB in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$sha/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA / Total",brk2=seq(0,1,.05))
savePlot("PropSHA in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$yft/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT / Total")
savePlot("PropYFT in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$mls/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS / Total",brk2=seq(0,1,.05))
savePlot("PropMLS in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$sbt/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT / Total",brk2=seq(0,1,.05))
savePlot("PropSBT in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$blm/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM / Total",brk2=seq(0,1,.05))
savePlot("PropBLM in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$bum/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM / Total",brk2=seq(0,1,.05))
savePlot("PropBUM in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$oth/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH / Total",brk2=seq(0,1,.05))
savePlot("PropOTH in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$skj/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ / Total",brk2=seq(0,1,.05))
savePlot("PropSKJ in Total5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$ott/(a5$Total),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT / Total",brk2=seq(0,1,.05))
savePlot("PropOTT in Total5",type="png")

########### relative to YBA
windows(width=20,height=15);par(mfrow=c(2,2),mar=c(2,2,2,2))
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$bet/(a$Total2),dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET / YBA Total")
savePlot("PropBET in altTotal",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$alb/(a$Total2),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB / YBA Total",brk2=seq(0,1,.1))
savePlot("PropALB in altTotal",type="png")
for(d in seq(1995,2010,5)) plot_catchmap(indat=a,vb1=a$yft/(a$Total2),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT / YBA Total")
savePlot("PropYFT in altTotal",type="png")

windows(width=20,height=15);par(mfrow=c(2,3),mar=c(2,2,2,2))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$bet/(a5$Total2),dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET / YBA Total")
savePlot("PropBET in altTotal5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3),mar=c(2,2,2,2))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$alb/(a5$Total2),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB / YBA Total",brk2=seq(0,1,.1))
savePlot("PropALB in altTotal5",type="png")
windows(width=20,height=15);par(mfrow=c(2,3),mar=c(2,2,2,2))
for(d in seq(1970,2010,10)) plot_catchmap(indat=a5,vb1=a5$yft/(a5$Total2),dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT / YBA Total")
savePlot("PropYFT in altTotal5",type="png")

#Catch maps
windows(width=20,height=15);par(mfrow=c(2,2))
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$bet,dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET Catch")
savePlot("Catchmap_BET",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$swo,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO Catch")
savePlot("Catchmap_SWO",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$alb,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB Catch")
savePlot("Catchmap_ALB",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$otb,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA Catch")
savePlot("Catchmap_OTB",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$sha,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA Catch")
savePlot("Catchmap_SHA",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$yft,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT Catch")
savePlot("Catchmap_YFT",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$mls,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS Catch")
savePlot("Catchmap_MLS",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$sbt,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT Catch")
savePlot("Catchmap_SBT",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$blm,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM Catch")
savePlot("Catchmap_BLM",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$bum,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM Catch")
savePlot("Catchmap_BUM",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$oth,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH Catch")
savePlot("Catchmap_OTH",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$skj,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ Catch")
savePlot("Catchmap_SKJ",type="png")
for(d in seq(1995,2010,5)) plot_catchmap2(indat=a,vb1=a$ott,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT Catch")
savePlot("Catchmap_OTT",type="png")

windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$bet,dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET Catch")
savePlot("Catchmap5_BET",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$swo,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO Catch")
savePlot("Catchmap5_SWO",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$alb,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB Catch")
savePlot("Catchmap5_ALB",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$otb,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA Catch")
savePlot("Catchmap5_OTB",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$sha,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA Catch")
savePlot("Catchmap5_SHA",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$yft,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT Catch")
savePlot("Catchmap5_YFT",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$mls,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS Catch")
savePlot("Catchmap5_MLS",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$sbt,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT Catch")
savePlot("Catchmap5_SBT",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$blm,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM Catch")
savePlot("Catchmap5_BLM",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$bum,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM Catch")
savePlot("Catchmap5_BUM",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$oth,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH Catch")
savePlot("Catchmap5_OTH",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$skj,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ Catch")
savePlot("Catchmap5_SKJ",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_catchmap2(indat=a5,vb1=a5$ott,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT Catch")
savePlot("Catchmap5_OTT",type="png")

#CPUE maps
windows(width=20,height=15);par(mfrow=c(2,2))
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$bet,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET CPUE")
savePlot("Cpuemap_BET",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$swo,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO CPUE")
savePlot("Cpuemap_SWO",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$alb,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB CPUE")
savePlot("Cpuemap_ALB",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$otb,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA CPUE")
savePlot("Cpuemap_OTB",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$sha,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA CPUE")
savePlot("Cpuemap_SHA",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$yft,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT CPUE")
savePlot("Cpuemap_YFT",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$mls,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS CPUE")
savePlot("Cpuemap_MLS",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$sbt,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT CPUE")
savePlot("Cpuemap_SBT",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$blm,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM CPUE")
savePlot("Cpuemap_BLM",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$bum,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM CPUE")
savePlot("Cpuemap_BUM",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$oth,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH CPUE")
savePlot("Cpuemap_OTH",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$skj,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ CPUE")
savePlot("Cpuemap_SKJ",type="png")
for(d in seq(1995,2010,5)) plot_cpuemap2(indat=a,vb1=a$ott,vb2=a$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT CPUE")
savePlot("Cpuemap_OTT",type="png")

windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$bet,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(40,120),ti="BET CPUE")
savePlot("CPUEmap5_BET",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$swo,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SWO CPUE")
savePlot("CPUEmap5_SWO",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$alb,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="ALB CPUE")
savePlot("CPUEmap5_ALB",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$otb,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SFA CPUE")
savePlot("CPUEmap5_OTB",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$sha,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SHA CPUE")
savePlot("CPUEmap5_SHA",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$yft,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="YFT CPUE")
savePlot("CPUEmap5_YFT",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$mls,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="MLS CPUE")
savePlot("CPUEmap5_MLS",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$sbt,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SBT CPUE")
savePlot("CPUEmap5_SBT",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$blm,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BLM CPUE")
savePlot("CPUEmap5_BLM",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$bum,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="BUM CPUE")
savePlot("CPUEmap5_BUM",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$oth,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTH CPUE")
savePlot("CPUEmap5_OTH",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$skj,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="SKJ CPUE")
savePlot("CPUEmap5_SKJ",type="png")
windows(width=20,height=15);par(mfrow=c(2,3))
for(d in seq(1970,2010,10)) plot_cpuemap2(indat=a5,vb1=a5$ott,vb2=a5$hooks,dcd=d,latlim=c(-45,20),lonlim=c(20,120),ti="OTT CPUE")
...
for (r in regA2ord) {
  llv <- dat[dat$regA2==r,]
  hist(llv$dmy,breaks="days",freq=T,xlab="Date",main=paste("ALB2 Region",r))
  }
title("Sets per day",outer=T,line=0)
savePlot(filename=paste("Sets per day by region A2",sep=""),type="png")
...
for (r in regA2ord) {
  ...
  a <- tapply(llv$op_yr,llv$op_yr,length)
  plot(as.numeric(names(a)),a,xlab="yr",ylab="Logsheet records",main=paste("ALB2 Region",r),xlim=c(1975,2015))
  }
savePlot(filename=paste("Number of records A2",sep=""),type="png")
...
for (r in regA2ord) {
  ...
  title(paste0("Hooks per set ALB2 R",r),outer=T,line=0)
  savePlot(filename=paste0("Histogram hooks by decade ALB2 R",r),type="png")
}
...
for (r in regA2ord) {
  llv <- dat[dat$regA2==r,]
  a <- tapply(llv$vessid,llv$op_yr,lu)
  plot(names(a),a,xlab="Year",ylab="",main=paste("ALB2 Region",r))
  }
...
#    }
  ...
  vessyrs <- vessyrs[order(-floor(vessyrs$minyr),-floor(vessyrs$maxyr)),]
  vy[[r]] <- vessyrs
  plot(1:length(vess),1:length(vess),xlim=c(1975,2015),type="n",xlab="Years",ylab="Vessel",main=paste("ALB2 Region",r))
  for (i in 1:length(vess)) {
    lines(c(floor(vessyrs[i,]$minyr),floor(vessyrs[i,]$maxyr)),c(i,i))
    }
  }
savePlot(filename=paste("Time distribution of vessels ALB2 1",sep=""),type="png")
...
a <- as.numeric(unique(tonn))
legend("bottomleft",legend=levels(tonn)[a],col=a,lty=1)
savePlot(filename=paste("Time distribution of vessels ALB2 1b",sep=""),type="png")
...
savePlot(filename=paste("Time distribution of vessels ALB2 2",sep=""),type="png")
...
a <- as.numeric(unique(tonn))
legend("topright",legend=levels(tonn)[a],col=a,lty=1)
savePlot(filename=paste("Time distribution of vessels ALB2 2b",sep=""),type="png")
...
savePlot(filename=paste("Time distribution of vessels ALB2 4",sep=""),type="png")
...
for (r in regYord) {
  llv <- dat[dat$regY==r,]
  a <- tapply(llv$hooks,llv$yrqtr,length)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Sets",main=paste("YFT Region",r),col=1,pch=16)
  for (tt in allt) {
...
for (r in regA2ord) {
  llv <- dat[dat$regA2==r,]
  a <- tapply(llv$hooks,llv$yrqtr,length)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Sets",main=paste("ALB2 Region",r),col=1,pch=16)
  for (tt in allt) {
    llv2 <- llv[llv$tonnage==tt,]
    a2 <- tapply(llv2$hooks,llv2$yrqtr,length)
    lines(as.numeric(names(a2)),a2,col=nallt[match(tt,allt)])
...
savePlot(filename="Sets by region by yrqtr by tonnage ALB2",type="png")
...
for (r in regBord) {
  llv <- dat[dat$regB==r,]
  a <- tapply(llv$hooks,llv$yrqtr,length)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Sets",main=paste("BET Region",r),col=1,pch=16)
  for (tt in allt) {
    llv2 <- llv[llv$tonnage==tt,]
    a2 <- tapply(llv2$hooks,llv2$yrqtr,length)
    lines(as.numeric(names(a2)),a2,col=nallt[match(tt,allt)])
...
savePlot(filename="Sets by region by yrqtr by tonnage BET",type="png")
...
for (r in regYord) {
  llv <- dat[dat$regY==r,]
  a <- tapply(llv$hooks,llv$yrqtr,sum)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Hooks",main=paste("YFT Region",r),col=1,pch=16)
  for (tt in allt) {
    llv2 <- llv[llv$tonnage==tt,]
...
for (r in regA2ord) {
  llv <- dat[dat$regA2==r,]
  a <- tapply(llv$hooks,llv$yrqtr,sum)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Hooks",main=paste("ALB2 Region",r),col=1,pch=16)
  for (tt in allt) {
    llv2 <- llv[llv$tonnage==tt,]
    a2 <- tapply(llv2$hooks,llv2$yrqtr,sum)
    lines(as.numeric(names(a2)),a2,col=nallt[match(tt,allt)])
...
savePlot(filename="Effort by region by yrqtr by tonnage ALB2",type="png")
...
for (r in regBord) {
  llv <- dat[dat$regB==r,]
  a <- tapply(llv$hooks,llv$yrqtr,sum)
  plot(as.numeric(names(a)),a,xlab="Year",ylab="Hooks",main=paste("BET Region",r),col=1,pch=16)
  for (tt in allt) {
    llv2 <- llv[llv$tonnage==tt,]
    a2 <- tapply(llv2$hooks,llv2$yrqtr,sum)
    lines(as.numeric(names(a2)),a2,col=nallt[match(tt,allt)])
...
savePlot(filename="Effort by region by yrqtr by tonnage BET",type="png")

# total effort by region and yearqtr
e <- tapply(dat$hooks,list(dat$yrqtr,dat$regY,dat$tonnage),sum)
...
for(dec in seq(1975,2010,5)) {
  a <- dat[dat$op_yr >= dec & dat$op_yr < dec+5 & dat$regA2 %in% c(1:4),]
  x <- tapply(a$hooks,list(a$lon5,a$lat5),sum)
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),is.na(x),col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(30,120),main=dec)
...
savePlot(filename=paste0("Map hooks by decade ALB2"),type="png")


windows(height=16,width=14); par(mfrow=c(4,2),mar=c(3,4,2,1))
for(dec in seq(1975,2010,5)) {
  a <- dat[dat$op_yr >= dec & dat$op_yr < dec+5 & dat$regA2 %in% c(1:4),]
  x <- tapply(a$hooks,list(a$lon5,a$lat5),length)
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),is.na(x),col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(30,120),main=dec)
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,xlab="Longitude",ylab="Latitude",
...
savePlot(filename=paste0("Map sets by decade ALB2"),type="png")

windows(height=16,width=20); par(mfrow=c(6,6),mar=c(1,1,1,1))
llv <- dat[dat$regA2 %in% c(1:4),]
for(dec in seq(1979,2014,1)) {
  a <- llv[llv$op_yr >= dec & llv$op_yr < dec+1,]
  x <- tapply(a$hooks,list(a$lon5,a$lat5),length)
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),is.na(x),col="lightblue",xlab="Longitude",ylab="Latitude",
    xlim=c(30,120),main=dec,axes=F)
  image(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,xlab="Longitude",ylab="Latitude",
    xlim=c(30,120),main=dec,add=T,breaks=exp(seq(0,11,length.out=13)))
  contour(as.numeric(dimnames(x)[[1]]),as.numeric(dimnames(x)[[2]]),x,add=T,
    levels=c(10,10^2,10^3,10^4,10^5,10^6,10^7,10^8,10^9,10^10,10^1,10^12))
  map("world",add=T, interior=F,fill=T)
  }
savePlot(filename=paste0("Map sets by year ALB2"),type="png")
...
for (r in regA2ord) {
  llv <- dat[dat$regA2==r,]
  llvold <- datold[datold$regA2==r,]
  a <- tapply(llv$op_yr,llv$op_yr,length)
  b <- tapply(llvold$op_yr,llvold$op_yr,length)
  plot(names(a),(b-a)/b,type="l",ylim=c(0,1),ylab="Proportion single species",main=paste0("R",r))
  }
savePlot(file="proportion_single_species_region_A2",type="png")
...
windows(height=14,width=12); par(mfcol=c(3,2),mar=c(3,2,2,1),oma=c(0,0,1,0))
for (r in regYord) {
  llvstd <- dat_std[dat_std$regY==r,]
  llvall <- prepdat[prepdat$regY==r,]
...
b <- tapply(allz,list(dat$op_yr,dat$regY),mean)
regYord <- c(1,2,3,6,5,4)
windows(height=14,width=12); par(mfcol=c(3,2),mar=c(3,2,2,1),oma=c(0,0,1,0))
for (r in regYord) {
  llv <- b[,r+1]
...
b <- tapply(allz,list(prepdat$op_yr,prepdat$regY),mean)
regYord <- c(1,2,3,6,5,4)
windows(height=14,width=12); par(mfcol=c(3,2),mar=c(3,2,2,1),oma=c(0,0,1,0))
for (r in regYord) {
  llv <- b[,r+1]
...
for (r in regYord) {
  ...
  plot(yq,yftrat,ylim=c(0,2),pch=3,xlab="Year",ylab="Relative CPUE",main=paste("YFT Region",r),xlim=range(dat$yrqtr))
...
for (tt in allt) {
  for (r in regYord) {
    llv <- dat[dat$regY==r & dat$tonnage==tt,]
    if(dim(llv)[1] > 0) {
    yft <- tapply(llv$yft,llv$yrqtr,sum)
    eff <- tapply(llv$hooks,llv$yrqtr,sum)
    bet <- tapply(llv$bet,llv$yrqtr,sum)
...
for (r in regYord) {
  ...
  ab <- 1*ab/a
  maxy <- max(c(ay,ab))
  plot(names(ay),ay,xlim=range(dat$yrqtr),ylim=c(0,1),xlab="Year",ylab="Proportion of zero catches",main=paste("YFT Region",r))
...
for (r in regYord) {
  ...
  plot(names(aswo),aswo,xlim=range(dat$yrqtr),ylim=c(0,1),xlab="Year",ylab="Proportion of zero catches",main=paste("YFT Region",r))
...
for (r in regYord) {
  ...
  ott <- 1*ott/a
  maxy <- max(c(oth,sha,skj,ott))
  plot(names(oth),oth,xlim=range(dat$yrqtr),ylim=c(0,1),xlab="Year",ylab="Proportion of zero catches",main=paste("YFT Region",r))
  points(names(sha),sha,col=2,pch=2)
  points(names(skj),skj,col=3,pch=3)
  points(names(ott),ott,col=4,pch=4)
...
for (tt in 4:6) {
  for (r in regYord) {
    ...
    plot(names(ay),ay,ylim=c(0,1),xlab="Year",ylab="Proportion of zero catches",main=paste("YFT Region",r))
    points(names(ab),ab,col=2,pch=2)
    points(names(aalb),aalb,col=3,pch=3)
...
windows(height=14,width=12); par(mfcol=c(3,2),mar=c(3,4,2,1),oma=c(1,1,3,1)); r<-3; hh <- 18
  b<- dat
  for (r in regYord) {
    a <- b[b$regY==r & b$op_yr > 1990,]
    yrs <- sort(unique(a$op_yr))
    a <- table(floor(a$hbf),a$op_yr)
    plot(1,1, type="n", xlab="Year", ylab="HBF", ylim = c(1,25), xlim=c(1994,2014),main=paste("YFT Region",r))
