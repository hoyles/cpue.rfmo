...
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = TRUE, dohbf = FALSE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 30)
...
dir.create(resdir); setwd(resdir)
runpars[["regBepo"]] <-list(runsp = "bet", regtype2 = "Bepo", clk = clk_Bepo, doregs = 1:4, ylall = c(1979, 2018), addcl = TRUE, dohbf = TRUE, dohook = TRUE, rm_hbfna = TRUE, cltype = "hcltrp", minss = regBepo_minss, strsmp = 30)
run_standardization(runpars, doflags = c("JP","KR","TW"), regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0, jplimit = list(reg=0, yr=21000))
