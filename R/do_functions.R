...
do_deltalogx <- function(dat, dohbf = F, addboat = F, addcl = addcl, nhbf = 3, runsp, fname, modlab, keepd = TRUE, lat5xqtr = T, lat5xyr = T, bcorr = FALSE) {
  ...
  fmla1.bin_ncl <- make_formula_IOx(runsp, modtype = "deltabin", dohbf = dohbf, addboat = addboat, addcl = F, nhbf = nhbf, lat5xqtr = lat5xqtr,
                                    lat5xyr = lat5xyr)
  fmla1.pos_ncl <- make_formula_IOx(runsp, modtype = "deltapos", dohbf = dohbf, addboat = addboat, addcl = F, nhbf = nhbf, lat5xqtr = lat5xqtr,
                                    lat5xyr = lat5xyr)
  ...
  summarize_and_store_dlx(modb1 = modelbin1, modb2 = modelbin2, modp1 = modelpos1, modp2 = modelpos2, dat = dat, datpos = datpos, fname, modlab = modlab,
                          dohbf = dohbf, addcl = addcl, keepd = keepd, bcorr, cell_areas)
}
