...
resdir <- paste0(jalysis_dir,"cl1_hb0_hk1/")
dir.create(resdir)
setwd(resdir)
...
run_standardization(runpars, doflags = "JP", regstr = "regBepo", maxyr = 2018, do_early = FALSE, stdlabs = stdlabs, projdir = projdir, twlimit=0 , jplimit = list(reg=0, yr=21000))

# with clusters, hooks, hbf
resdir <- paste0(jalysis_dir,"cl1_hb1_hk1/")
dir.create(resdir)
setwd(resdir)
...
resdir <- paste0(jalysis_dir,"cl0_hb1_hk1/")
dir.create(resdir)
setwd(resdir)
...
resdir <- paste0(jalysis_dir,"cl0_hb0_hk1/")
dir.create(resdir)
setwd(resdir)
